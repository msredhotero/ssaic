...
include ('../../includes/funcionesAdministrativo.php');

$serviciosFunciones 	= new Servicios();
$serviciosUsuario 		= new ServiciosUsuarios();
$serviciosHTML 			= new ServiciosHTML();
$serviciosReferencias 	= new ServiciosAdministrativos();

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Countries",$_SESSION['refroll_predio'],utf8_encode($_SESSION['torneo_predio']),1,0,0);
...
$tituloWeb = "Gestión: Asociación Intercountry De Fútbol";
//////////////////////// Fin opciones ////////////////////////////////////////////////
