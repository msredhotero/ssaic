...
function FixturePagina($serviciosDatos) {
	...
	for ($i=$idfecha;$i>=23;$i--) {
		...
		$res2 = $serviciosDatos->traerResultadosPorTorneoZonaFecha($idtorneo,$idzona,$i);
		$fechajuego = mysql_result($res2,0,'fechajuego');
		$cad = $cad.'
				<div class="col-md-6">
				<div class="panel panel-predio" style="margin-top:20px;">
                                <div class="panel-heading">
                                	<h3 class="panel-title">'.mysql_result($serviciosDatos->TraerFechaPorId($i),0,1).' - '.str_replace('-', '/', $fechajuego).'</h3>
