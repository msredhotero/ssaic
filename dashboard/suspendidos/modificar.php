...
$resMenu = $serviciosHTML->menu($_SESSION['nombre_predio'],"Suspendidos",$_SESSION['refroll_predio'],utf8_encode($_SESSION['torneo_predio']),0,1,0);
...
$idFixture = mysql_result($resResultado,0,'reffixture');
